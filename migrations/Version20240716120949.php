 ...
 */
final class Version20240716120949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category DROP one_to_many');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD one_to_many VARCHAR(255) DEFAULT NULL');
